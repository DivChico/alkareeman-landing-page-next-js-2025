...
const Footer = () => {
  ...
  return (
    <footer
      className={`${cairo.className} relative bg-fontPrimary flex flex-col items-center pt-4 sm:pt-6 md:pt-6 justify-between px-4 sm:px-6 md:px-8`}
    >
      {/* links */}
      <div className="w-full gap-4 sm:gap-6 md:gap-12 lg:gap-24 flex flex-col sm:flex-row-reverse justify-between md:px-8 lg:px-16 items-center mb-8 sm:mb-10">
        {/* logo and name */}
        <div className="flex justify-center items-center gap-2 mb-4 sm:mb-0">
          <div className="text-xl sm:text-xl md:text-xl text-bgTertiary font-bold text-center">
            {t("companyName")}
          </div>
          <div className="relative w-[60px] h-[60px] sm:w-[60px] sm:h-[60px] md:w-[70px] md:h-[70px]">
            <Image
              src="/logo.png"
              alt="Company Logo"
              width={50}
        ...
        {/* links */}
        <div className="flex flex-row items-center justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-24">
          ...
          <ul className="space-y-2 sm:space-y-2">
            <li>
              <FooterLink href="/contact-us">{t("requestService")}</FooterLink>
            </li>
            <li>
...
const FooterLink = ({ children, href }) => {
  return (
    <a href={href} className="block">
      <li className="text-white text-sm sm:text-sm md:text-base flex items-center justify-center hover:font-semibold hover:text-bgTertiary hover:scale-105 transition-all duration-300 ease-in-out">
        {children}
      </li>
    </a>
  );

  ...
  return (
    ...
    >
      <div className="w-full max-w-[90%] sm:max-w-md">
        ...
        >
          <h2 className="font-bold text-fontPrimary text-2xl sm:text-3xl md:text-4xl">{t("title")}</h2>
          <div className="space-y-2 sm:space-y-3">
            <p className="leading-6 sm:leading-7 md:leading-8 text-white text-sm sm:text-base md:text-lg">{t("description1")}</p>
            <p className="leading-6 sm:leading-7 md:leading-8 text-white text-sm sm:text-base md:text-lg">{t("description2")}</p>
          </div>
          <a

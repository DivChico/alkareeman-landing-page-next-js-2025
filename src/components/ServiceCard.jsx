...
const ServiceCard = ({ image, text, backText }) => {
  return (
    <div className="h-[180px] w-[300px] relative  rounded-2xl group cursor-pointer ">
      <div className="w-full h-full bg-white flex  flex-row-reverse items-center justify-center rounded-2xl gap-2">
        <div>
